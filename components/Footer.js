      ...
      <div className={'row'}>
        ...
        <Column title="Социальные сети" ulClass="social">
          <li>
            <a
              ...
              href="https://facebook.com/theatreglazalmaz/"
            >
              <span className="label">Facebook</span>
            </a>
          </li>
          <li>
            <a className="icon fa-vk" href="https://vk.com/theatreglazalmaz">
              <span className="label">ВКонтакте</span>
            </a>
          </li>
          <li>
            <a
              className="icon fa-instagram"
              href="https://instagram.com/theatreglazalmaz/"
            >
        ...
        <Column title="Контакты" ulClass="contact">
          <li>
            <h3>Адрес</h3>
            <p>
              <a href="https://yandex.ru/maps/-/CCQ3AMCYOB">
      ...
      <div className="container">
        <Columns>
          <div className="col-12">
            <div id="copyright">
              <ul className="links">
                <li>&copy; ГлазАлмаз. All rights reserved.</li>
                <li>
                  Design: <a href="https://vk.com/wanni">Magnarius</a>
                </li>
              </ul>
            </div>
          </div>
